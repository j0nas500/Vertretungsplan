...
public class VertretungsplanLehrerActivity extends AppCompatActivity {
...
// ZEIT Bite nichts verändern
        ...
        if (!isNetworkAvailable()) { // loading offline
            ...
            Toast.makeText(VertretungsplanLehrerActivity.this, "Offlinemodus", Toast.LENGTH_LONG).show();
        }
        // URL laden
        webView.loadUrl("https://files.itslearning.com/data/2226/3/vertretungsplan%20lehrer"+datum+".html");
        ...
        toggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    webView.loadUrl("https://files.itslearning.com/data/2226/3/vertretungsplan%20lehrer"+datumtoday+".html");
                } else {
                    Toast.makeText(getApplicationContext(), "Vertretungsplan für Morgen wird geladen", Toast.LENGTH_SHORT).show();
                    webView.loadUrl("https://files.itslearning.com/data/2226/3/vertretungsplan%20lehrer"+datumtomorrow+".html");
                }
            }
        });
